...
This document describes the release process for `kube-election`.
...
**Monitor the release:**
- Go to: https://github.com/ctxswitch/kube-election/actions
- Watch the "Release" workflow
- Check: https://github.com/ctxswitch/kube-election/releases
- Verify: https://crates.io/crates/kube-election
...
1. Go to: https://github.com/ctxswitch/kube-election/releases/new
...
**Full Changelog**: https://github.com/ctxswitch/kube-election/compare/v0.1.0...v0.2.0
```
...
```bash
# Check crates.io
curl -s https://crates.io/api/v1/crates/kube-election | jq '.crate.max_version'
